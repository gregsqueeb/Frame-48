 ...
 * |--------+--------+--------+--------+--------+--------+--------------------|        |--------+--------+--------+--------+--------+--------+--------|
 *         KC_EQUAL,   LOWER,  KC_LCTL, KC_RALT,   KC_LCMD,  KC_KB_VOLUME_DOWN|        |         KC_SPC,  RAISE,  KC_SLASH, KC_LEFT, KC_DOWN, KC_RIGHT
 *                                       |------------------------------------|        |--------------------------|
 */
[_QWERTY] = LAYOUT_frame_48(
    ...
    KC_LSFT,    KC_Z,     KC_X,       KC_C,       KC_V,     KC_B,     KC_SPC,                     KC_RCMD,    KC_N,       KC_M,         KC_COMM,    KC_DOT,   KC_UP,    KC_ENTER,
    KC_MINUS,   KC_EQUAL, MO(_LOWER), KC_LCTL,    KC_RALT,  KC_LCMD,                                          KC_SPC,     MO(_RAISE),   KC_SLASH,      KC_LEFT,  KC_DOWN,  KC_RIGHT
),
...
[_LOWER] = LAYOUT_frame_48(
    ...
    KC_TRNS,    KC_TRNS,  MO(_LOWER),  KC_TRNS,    KC_TRNS,  KC_TRNS,                                         KC_TRNS,    MO(_RAISE),  KC_ENT,       KC_RALT,  KC_TRNS,  KC_TRNS
),
...
[_RAISE] = LAYOUT_frame_48(
    ...
    KC_TRNS,    KC_TRNS,  MO(_LOWER),  KC_TRNS,  KC_SPC,   KC_TRNS,                                         KC_TRNS,    MO(_RAISE), KC_ENT,     KC_RALT,  KC_TRNS,  KC_TRNS
),
[_ADJUST] = LAYOUT_frame_48(
    KC_TRNS,    KC_TRNS,  KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,                                         KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
    KC_TRNS,    KC_TRNS,  KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,                   KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
    KC_TRNS,    KC_TRNS,  KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,                   KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
    KC_TRNS,    KC_TRNS,  MO(_LOWER),  KC_TRNS,    KC_TRNS,  KC_TRNS,                                         KC_TRNS,    MO(_RAISE),  KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS
),
};
